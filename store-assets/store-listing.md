# Resurface - Chrome Web Store Listing
...
🚀 QUICK ACCESS
• New Tab includes shortcuts to Gmail, Drive, YouTube, Maps & more
...
• ⌘+Shift+S / Ctrl+Shift+S - Save current page
• ⌘+Shift+F / Ctrl+Shift+F - Search saved pages
• rs <query> - Search from URL bar
...
🔖 Resurface - Close tabs without fear

Save any page with one click. Auto-captures the search that led you there. Resurfaces when you search related topics.

✨ Features:
• Smart save with ⌘+Shift+S
• Custom New Tab with unified search
• Google overlay for saved pages
• Full dashboard to manage everything

Your data stays local. Always.

#ChromeExtension #Productivity #TabManager
